...
T1 M06 (Change to face mill, 4", 2.375 offset from center hold to edge of material)
G43 H1 (tool length offset, measured from top of parallels, bottom of part)

G00 X2.5 Y-2.375 Z1.75
S600 M03 M08 (Spindle on clockwise rotation with coolant)
...
G01 X-2.5 (climb mill through top face of part moving left to right)
G00 Z.5 (safe height)
G00 X2.5
...
G00 X0.0 Y-7.0 Z4.0 M05 M09 (operator friendly position and stop spindle/coolant)
