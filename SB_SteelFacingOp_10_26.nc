%
O14222 (Solace steel facing op v10_26)
(This program assumes you have both work offset and tool offsets set correctly)
(The work offset should zero X Y at rear left edge and Z at rough work surface)
(The tool offset should be for a facing mill, or here the 4 inch shell mill)
G17 G20 G40 G80 G90 G94 (Safe line)
G54 (fixture offset)
T1 M06 
G43 H1 
S280 (200-400 SFM for mild steel w carbide -> 300 * 3.82 / 4 = 286.5 RPM )
F10.0 (280 RPM x 9 teeth x 0.004 inches/tooth = 10.08 IPM)
G00 X1.85 Y2.1 Z7.0 (rapid to right rear of part with safe Z distance)
G00 Z.75
G00 Z0
...
G01 Y-3.1 (climb mill through top face of part moving cutter front to back)
G00 Y2.1 Z.200 (back off and rapid return Y to start position)
(finishing pass, half the feed rate)
F5.0 (280 RPM x 9 teeth x 0.002 inches/tooth = 5.04 IPM)
