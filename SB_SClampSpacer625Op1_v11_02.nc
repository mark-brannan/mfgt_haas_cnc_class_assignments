...
G01 Z-0.920 (Move Z the length of your part .625 + the part off tool .25 + 0.02)
...
G01 Z-0.920 (Move Z the length of the part .625 + the part off tool width .25 + 0.02 for finish facing pass)
G01 X0.385 (back off X)
M09
G00 X5.0 Z5.0
M01 (Optional stop)
...
M08
G00 Z-0.920 (Rapid Z the length of your part .625 + the part off tool width .25 + 0.02 for finish facing pass)
